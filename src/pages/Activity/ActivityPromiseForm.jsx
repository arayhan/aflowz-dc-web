import { AlertErrors, BannerFeature, FormActivityDetail, FormActivityPromise } from '@/components/molecules';
...
const ActivityPromiseForm = () => {
	...
	const { activityItem, errorsActivityPromise, fetchingActivityItem, getActivityItem } = useActivityStore();
			...
			<section className="bg-gray-100">
				<div className="container py-16">
					<div className="max-w-screen-lg mx-auto space-y-3">
						{errorsActivityPromise && <AlertErrors errors={errorsActivityPromise} />}
