...
export const SearchOnTable = ({ onChange, placeholder, value, search, clear }) => {
	return (
		<>
			...
			<Button className="mx-1 px-5 py-1 rounded-lg" variant={'primary'} type="button" onClick={search}>
				Cari
			</Button>
			<Button className="px-5 py-1 rounded-lg" variant={'warning'} type="button" onClick={clear}>
				Clear
			</Button>
		</>
	);
