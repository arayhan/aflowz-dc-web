...
export const InputSelectPICVillage = forwardRef(
...
InputSelectPICVillage.displayName = 'InputSelectPICVillage';
InputSelectPICVillage.defaultProps = {
	name: 'village',
	multiple: false,
	label: 'Pilih PIC Kelurahan/Desa',
	params: {},
	containerClassName: '',
	showLabel: true
};
