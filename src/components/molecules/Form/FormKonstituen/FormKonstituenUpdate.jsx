		...
		<div>
			<div className="space-y-8">
				...
				<div className="grid md:grid-cols-2 gap-x-8 gap-y-6">
					<div>
						<InputText
							...
							defaultValue={konstituenDetail?.konstituen_name}
					...
					<div>
						<InputSelectKonstituen
							selectedKonstituen={setTypeKonstituen}
							setPlaceholder={konstituenDetail?.konstituen_type}
						/>
					...
					<div>
						<InputText
							...
							defaultValue={konstituenDetail?.alamat_konstituen}
					...
					<div>
						<InputText
							...
							defaultValue={konstituenDetail?.konstituen_pic}
					...
					<div>
						<InputText
							...
							defaultValue={konstituenDetail?.konstituen_pic_mobile}
				...
				<div className="flex justify-end">
					<button
						className="px-7 py-3 rounded-sm inline-block text-center transition-all bg-primary-500 hover:bg-primary-400 disabled:bg-primary-300 text-white mx-2 disabled:bg-opacity-50 disabled:hover:bg-primary-500 disabled:hover:bg-opacity-50 disabled:cursor-not-allowed"
						disabled={
							(inputNamaInstitusi || typeKonstituen || inputAlamat || inputNamaPIC || inputMobilePIC) !== '' ||
							(selectCity || selectStaff) !== 0
								? false
								: true
						}
						onClick={handleForm}
					...
					<button
						className="px-7 py-3 rounded-sm inline-block text-center transition-all bg-white hover:bg-primary-200 text-primary-200 hover:text-primary-100 border"
						onClick={() => navigate('/konstituen')}
					>
						Cancel
					</button>
				</div>
